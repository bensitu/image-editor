...
import type { AnnotationObject, BaseImageObject, EditorToolMode, ImageEditorCallbackContext, ImageEditorOperation, ImageEditorSelection, ImageEditorState, MaskObject } from '../core/public-types.js';
...
export interface LegacyOperationPort {
    ...
    run<TResult>(operationId: ImageEditorOperation, body: () => TResult | Promise<TResult>): Promise<TResult>;
}
...
export interface LegacyExportContributorPort {
    register(id: string, render: (workspace: FabricNS.StaticCanvas) => void | Promise<void>): LegacyDisposer;
}
...
export interface LegacyCallbackPort {
    ...
    emitAnnotationsChanged(annotations: readonly AnnotationObject[], context: ImageEditorCallbackContext): void;
