...
export type { CapabilityProviderDefinition, CapabilityProviderOptions, ConfigurablePluginApi, DisposableScope, PluginManifest, OptionalCapabilityStatus, PluginPermission, PluginSetupContext, PluginToolStatus, PluginToolStatusListener, PluginToolStatusSubscriptionOptions, SynchronousEditorPlugin, } from '../plugin-kernel/plugin-types.js';
