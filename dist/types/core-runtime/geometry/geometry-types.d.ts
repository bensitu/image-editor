...
export interface GeometryMutationParticipant<TPrepared = unknown> {
    ...
    prepare?(mutation: GeometryMutationDescriptor, context: GeometryParticipantContext): MaybePromise<TPrepared>;
    apply(mutation: GeometryMutationDescriptor, prepared: TPrepared, context: GeometryParticipantContext): MaybePromise<void>;
