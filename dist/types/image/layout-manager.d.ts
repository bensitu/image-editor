 ...
 *
 */
export declare function computeExpandLayout(imageWidth: number, imageHeight: number, _optionsCanvasWidth: number, _optionsCanvasHeight: number, containerSize: ViewportSize): LayoutResult;
/**
