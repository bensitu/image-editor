...
export { AFFINE_EPSILON, IDENTITY_AFFINE_MATRIX, affineDeterminant, applyAffineToPoint, approximatelyEqualAffine, assertAffineMatrix, computeAffineDelta, hasAffineReflection, invertAffine, isFiniteAffineMatrix, multiplyAffine, sanitizeAffineMatrix, transformRectBounds, type AffineMatrix, type Point, type Rect, } from '../core-runtime/geometry/affine-matrix.js';
export type { BaseImageGeometrySnapshot, GeometryMutationBaseContext, GeometryMutationDescriptor, GeometryMutationParticipant, GeometryMutationPort, GeometryMutationRequest, GeometryMutationRollbackContext, GeometryParticipantContext, Size, } from '../core-runtime/geometry/geometry-types.js';
export type { DocumentMutationContext, DocumentMutationDescriptor, DocumentMutationPort, } from '../core-runtime/mutation/index.js';
export type { DefaultMaskConfig, LabelConfig, MaskConfig, MaskFactoryOptions, MaskObject, OverlayListOrder, } from './public-types.js';
export * from '../core-runtime/state/index.js';
export { createCapabilityToken, definePluginRef, type CapabilityRequirement, type CapabilityToken, type Disposable, type PluginImageLifecycleContext, type PluginLifecycleContext, type PluginRef, type PluginSetupContext, type SynchronousEditorPlugin, } from '../plugin-kernel/index.js';
