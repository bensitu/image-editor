...
export { createDisposable, createNoopDisposable, disposeInReverse, disposeInReverseSync, isPromiseLike, observePromise, type CommitAwareDisposable, type Disposable, type DisposeInReverseOptions, type MaybePromise, } from './disposable.js';
export { CapabilityConflictError, CapabilityMissingError, CapabilityVersionError, InvalidCapabilityVersionError, InvalidPluginDefinitionError, OperationConflictError, OperationRegistrationError, PluginAggregateError, PluginAlreadyInstalledError, PluginBatchInstallError, PluginCapabilityError, PluginDefinitionConflictError, PluginDefinitionAlreadyBoundError, PluginDependencyCycleError, PluginDependencyError, PluginError, PluginKernelDisposedError, PluginKernelStateError, PluginLifecycleError, PluginNotInstalledError, PluginPermissionError, PluginSetupError, ToolRegistrationError, ToolTransitionError, type PluginCapabilityFailureReason, type PluginLifecyclePhase, } from './errors.js';
export { OperationRegistry, type OperationConflictDomain, type OperationDefinition, type OperationExecutionContext, type OperationId, type OperationMode, type OperationReentrancy, type OperationRunOptions, type OperationToken, } from './operation-registry.js';
...
export type { EditorPlugin, EditorPluginDefinition, CapabilityProviderOptions, PluginCapabilityReader, PluginCapabilitySetupAccess, PluginCommittedEventAccess, PluginCommittedEventSetupAccess, PluginImageLifecycleContext, PluginLifecycleContext, PluginOperationAccess, PluginOperationSetupAccess, PluginSetupContext, PluginToolAccess, PluginToolSetupAccess, PluginToolStatus, PluginToolStatusListener, PluginToolStatusSubscriptionOptions, SynchronousEditorPlugin, } from './plugin-types.js';
