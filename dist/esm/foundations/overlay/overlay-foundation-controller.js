...
import { createDisposable, disposeInReverseSync, } from '../../plugin-kernel/index.js';
...
export class OverlayFoundationController {
    ...
    registerSerializer(serializer) {
        ...
        if (this.serializers.has(serializer.kind)) {
            throw new CoreRuntimeError(`[ImageEditor] Overlay kind "${serializer.kind}" already has a serializer.`);
        }
