...
const runtimeRefreshStates = new WeakMap();
...
function invalidatePendingRuntimeRefresh(owner) {
    ...
    state.pending = null;
    if (!(pending === null || pending === void 0 ? void 0 : pending.cancel))
        return;
    try {
        pending.cancel();
    }
...
export class DomControlsController {
...
//# sourceMappingURL=dom-controls-controller.js.map