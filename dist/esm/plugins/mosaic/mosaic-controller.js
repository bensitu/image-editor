...
export class MosaicController {
    ...
    hideBrushPreview(session) {
        if (this.session !== session || session.brushPreview.visible === false)
            return;
    ...
    closeSession() {
        ...
        if (canvas === null || canvas === void 0 ? void 0 : canvas.getObjects().includes(session.brushPreview)) {
