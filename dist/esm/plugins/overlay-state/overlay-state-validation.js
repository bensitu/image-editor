...
export function resolveOverlayStateLimits(base = {}, override = {}) {
...
export function validateOverlayStateDocument(payload, limits) {
    const issues = [];
    const cloneContext = {
        limits,
        issues,
...
//# sourceMappingURL=overlay-state-validation.js.map