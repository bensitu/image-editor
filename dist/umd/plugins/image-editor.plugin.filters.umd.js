(function(global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.ImageEditorPlugins = global.ImageEditorPlugins || {},global.ImageEditorPlugins.Filters = global.ImageEditorPlugins.Filters || {}), global.ImageEditor));
...
//#region dist/esm/plugins/filters/index.js
	const filtersPluginRef = (0, _bensitu_image_editor_sdk.definePluginRef)("plugin:filters", "1.0.0");
	function filtersPlugin(options = {}) {
		...
		return (0, _bensitu_image_editor_sdk.definePlugin)({
			...
			setup(context) {
				...
				const exports = context.capabilities.require(_bensitu_image_editor_sdk.EXPORT_CONTRIBUTION_CAPABILITY);
				...
				context.capabilities.provide(_bensitu_image_editor_sdk.VISIBLE_RASTER_BAKE_CAPABILITY, visibleRasterBake, { version: _bensitu_image_editor_sdk.VISIBLE_RASTER_BAKE_CAPABILITY.version });
...
//# sourceMappingURL=image-editor.plugin.filters.umd.js.map