var ImageEditor=(()=>{var Z=(u,l)=>()=>(l||u((l={exports:{}}).exports,l),l.exports);var ae=Z((K,N)=>{function P(){/*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/babel/babel/blob/main/packages/babel-helpers/LICENSE */var u,l,I=typeof Symbol=="function"?Symbol:{},y=I.iterator||"@@iterator",S=I.toStringTag||"@@toStringTag";function o(s,d,m,k){var v=d&&d.prototype instanceof a?d:a,A=Object.create(v.prototype);return T(A,"_invoke",function(w,L,j){var O,b,h,g=0,p=j||[],f=!1,_={p:0,n:0,v:u,a:E,f:E.bind(u,4),d:function(C,M){return O=C,b=0,h=u,_.n=M,t}};function E(B,C){for(b=B,h=C,l=0;!f&&g&&!M&&l<p.length;l++){var M,x=p[l],W=_.p,R=x[2];B>3?(M=R===C)&&(h=x[(b=x[4])?5:(b=3,3)],x[4]=x[5]=u):x[0]<=W&&((M=B<2&&W<x[1])?(b=0,_.v=C,_.n=x[1]):W<R&&(M=B<3||x[0]>C||C>R)&&(x[4]=B,x[5]=C,_.n=R,b=0))}if(M||B>1)return t;throw f=!0,C}return function(B,C,M){if(g>1)throw TypeError("Generator is already running");for(f&&C===1&&E(C,M),b=C,h=M;(l=b<2?u:h)||!f;){O||(b?b<3?(b>1&&(_.n=-1),E(b,h)):_.n=h:_.v=h);try{if(g=2,O){if(b||(B="next"),l=O[B]){if(!(l=l.call(O,h)))throw TypeError("iterator result is not an object");if(!l.done)return l;h=l.value,b<2&&(b=0)}else b===1&&(l=O.return)&&l.call(O),b<2&&(h=TypeError("The iterator does not provide a '"+B+"' method"),b=1);O=u}else if((l=(f=_.n<0)?h:w.call(L,_))!==t)break}catch(x){O=u,b=1,h=x}finally{g=1}}return{value:l,done:f}}}(s,m,k),!0),A}var t={};function a(){}function n(){}function e(){}l=Object.getPrototypeOf;var i=[][y]?l(l([][y]())):(T(l={},y,function(){return this}),l),r=e.prototype=a.prototype=Object.create(i);function c(s){return Object.setPrototypeOf?Object.setPrototypeOf(s,e):(s.__proto__=e,T(s,S,"GeneratorFunction")),s.prototype=Object.create(r),s}return n.prototype=e,T(r,"constructor",e),T(e,"constructor",n),n.displayName="GeneratorFunction",T(e,S,"GeneratorFunction"),T(r),T(r,S,"Generator"),T(r,y,function(){return this}),T(r,"toString",function(){return"[object Generator]"}),(P=function(){return{w:o,m:c}})()}function T(u,l,I,y){var S=Object.defineProperty;try{S({},"",{})}catch{S=0}T=function(t,a,n,e){function i(r,c){T(t,r,function(s){return this._invoke(r,c,s)})}a?S?S(t,a,{value:n,enumerable:!e,configurable:!e,writable:!e}):t[a]=n:(i("next",0),i("throw",1),i("return",2))},T(u,l,I,y)}function $(u,l,I,y,S,o,t){try{var a=u[o](t),n=a.value}catch(e){return void I(e)}a.done?l(n):Promise.resolve(n).then(y,S)}function D(u){return function(){var l=this,I=arguments;return new Promise(function(y,S){var o=u.apply(l,I);function t(n){$(o,y,S,t,a,"next",n)}function a(n){$(o,y,S,t,a,"throw",n)}t(void 0)})}}function J(u,l){var I=Object.keys(u);if(Object.getOwnPropertySymbols){var y=Object.getOwnPropertySymbols(u);l&&(y=y.filter(function(S){return Object.getOwnPropertyDescriptor(u,S).enumerable})),I.push.apply(I,y)}return I}function H(u){for(var l=1;l<arguments.length;l++){var I=arguments[l]!=null?arguments[l]:{};l%2?J(Object(I),!0).forEach(function(y){ee(u,y,I[y])}):Object.getOwnPropertyDescriptors?Object.defineProperties(u,Object.getOwnPropertyDescriptors(I)):J(Object(I)).forEach(function(y){Object.defineProperty(u,y,Object.getOwnPropertyDescriptor(I,y))})}return u}function ee(u,l,I){return(l=Y(l))in u?Object.defineProperty(u,l,{value:I,enumerable:!0,configurable:!0,writable:!0}):u[l]=I,u}function z(u,l){if(!(u instanceof l))throw new TypeError("Cannot call a class as a function")}function X(u,l){for(var I=0;I<l.length;I++){var y=l[I];y.enumerable=y.enumerable||!1,y.configurable=!0,"value"in y&&(y.writable=!0),Object.defineProperty(u,Y(y.key),y)}}function Q(u,l,I){return l&&X(u.prototype,l),I&&X(u,I),Object.defineProperty(u,"prototype",{writable:!1}),u}function Y(u){var l=te(u,"string");return F(l)=="symbol"?l:l+""}function te(u,l){if(F(u)!="object"||!u)return u;var I=u[Symbol.toPrimitive];if(I!==void 0){var y=I.call(u,l||"default");if(F(y)!="object")return y;throw new TypeError("@@toPrimitive must return a primitive value.")}return(l==="string"?String:Number)(u)}function F(u){"@babel/helpers - typeof";return F=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(l){return typeof l}:function(l){return l&&typeof Symbol=="function"&&l.constructor===Symbol&&l!==Symbol.prototype?"symbol":typeof l},F(u)}/**
