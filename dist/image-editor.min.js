var ImageEditor=(()=>{var Z=(u,l)=>()=>(l||u((l={exports:{}}).exports,l),l.exports);var ae=Z((K,N)=>{function P(){/*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/babel/babel/blob/main/packages/babel-helpers/LICENSE */var u,l,I=typeof Symbol=="function"?Symbol:{},y=I.iterator||"@@iterator",E=I.toStringTag||"@@toStringTag";function o(s,f,v,_){var m=f&&f.prototype instanceof a?f:a,B=Object.create(m.prototype);return T(B,"_invoke",function(w,L,j){var A,b,h,g=0,p=j||[],d=!1,k={p:0,n:0,v:u,a:M,f:M.bind(u,4),d:function(S,C){return A=S,b=0,h=u,k.n=C,t}};function M(O,S){for(b=O,h=S,l=0;!d&&g&&!C&&l<p.length;l++){var C,x=p[l],W=k.p,R=x[2];O>3?(C=R===S)&&(h=x[(b=x[4])?5:(b=3,3)],x[4]=x[5]=u):x[0]<=W&&((C=O<2&&W<x[1])?(b=0,k.v=S,k.n=x[1]):W<R&&(C=O<3||x[0]>S||S>R)&&(x[4]=O,x[5]=S,k.n=R,b=0))}if(C||O>1)return t;throw d=!0,S}return function(O,S,C){if(g>1)throw TypeError("Generator is already running");for(d&&S===1&&M(S,C),b=S,h=C;(l=b<2?u:h)||!d;){A||(b?b<3?(b>1&&(k.n=-1),M(b,h)):k.n=h:k.v=h);try{if(g=2,A){if(b||(O="next"),l=A[O]){if(!(l=l.call(A,h)))throw TypeError("iterator result is not an object");if(!l.done)return l;h=l.value,b<2&&(b=0)}else b===1&&(l=A.return)&&l.call(A),b<2&&(h=TypeError("The iterator does not provide a '"+O+"' method"),b=1);A=u}else if((l=(d=k.n<0)?h:w.call(L,k))!==t)break}catch(x){A=u,b=1,h=x}finally{g=1}}return{value:l,done:d}}}(s,v,_),!0),B}var t={};function a(){}function n(){}function e(){}l=Object.getPrototypeOf;var i=[][y]?l(l([][y]())):(T(l={},y,function(){return this}),l),r=e.prototype=a.prototype=Object.create(i);function c(s){return Object.setPrototypeOf?Object.setPrototypeOf(s,e):(s.__proto__=e,T(s,E,"GeneratorFunction")),s.prototype=Object.create(r),s}return n.prototype=e,T(r,"constructor",e),T(e,"constructor",n),n.displayName="GeneratorFunction",T(e,E,"GeneratorFunction"),T(r),T(r,E,"Generator"),T(r,y,function(){return this}),T(r,"toString",function(){return"[object Generator]"}),(P=function(){return{w:o,m:c}})()}function T(u,l,I,y){var E=Object.defineProperty;try{E({},"",{})}catch{E=0}T=function(t,a,n,e){function i(r,c){T(t,r,function(s){return this._invoke(r,c,s)})}a?E?E(t,a,{value:n,enumerable:!e,configurable:!e,writable:!e}):t[a]=n:(i("next",0),i("throw",1),i("return",2))},T(u,l,I,y)}function $(u,l,I,y,E,o,t){try{var a=u[o](t),n=a.value}catch(e){return void I(e)}a.done?l(n):Promise.resolve(n).then(y,E)}function D(u){return function(){var l=this,I=arguments;return new Promise(function(y,E){var o=u.apply(l,I);function t(n){$(o,y,E,t,a,"next",n)}function a(n){$(o,y,E,t,a,"throw",n)}t(void 0)})}}function J(u,l){var I=Object.keys(u);if(Object.getOwnPropertySymbols){var y=Object.getOwnPropertySymbols(u);l&&(y=y.filter(function(E){return Object.getOwnPropertyDescriptor(u,E).enumerable})),I.push.apply(I,y)}return I}function H(u){for(var l=1;l<arguments.length;l++){var I=arguments[l]!=null?arguments[l]:{};l%2?J(Object(I),!0).forEach(function(y){ee(u,y,I[y])}):Object.getOwnPropertyDescriptors?Object.defineProperties(u,Object.getOwnPropertyDescriptors(I)):J(Object(I)).forEach(function(y){Object.defineProperty(u,y,Object.getOwnPropertyDescriptor(I,y))})}return u}function ee(u,l,I){return(l=Y(l))in u?Object.defineProperty(u,l,{value:I,enumerable:!0,configurable:!0,writable:!0}):u[l]=I,u}function z(u,l){if(!(u instanceof l))throw new TypeError("Cannot call a class as a function")}function X(u,l){for(var I=0;I<l.length;I++){var y=l[I];y.enumerable=y.enumerable||!1,y.configurable=!0,"value"in y&&(y.writable=!0),Object.defineProperty(u,Y(y.key),y)}}function Q(u,l,I){return l&&X(u.prototype,l),I&&X(u,I),Object.defineProperty(u,"prototype",{writable:!1}),u}function Y(u){var l=te(u,"string");return F(l)=="symbol"?l:l+""}function te(u,l){if(F(u)!="object"||!u)return u;var I=u[Symbol.toPrimitive];if(I!==void 0){var y=I.call(u,l||"default");if(F(y)!="object")return y;throw new TypeError("@@toPrimitive must return a primitive value.")}return(l==="string"?String:Number)(u)}function F(u){"@babel/helpers - typeof";return F=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(l){return typeof l}:function(l){return l&&typeof Symbol=="function"&&l.constructor===Symbol&&l!==Symbol.prototype?"symbol":typeof l},F(u)}/**
