...
const require_sdk = require('../../chunks/sdk-Czw13i49.cjs');
...
function domControlsPlugin(options = {}) {
	...
	return require_sdk.definePlugin({
		...
		setup(context) {
			...
			controller = new DomControlsController(configuredOptions, context.capabilities.require(require_core_capabilities.CORE_DIAGNOSTICS_CAPABILITY));
