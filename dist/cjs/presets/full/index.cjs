...
const require_annotation_text = require('../../chunks/annotation-text-CrgsBrs5.cjs');
const require_annotation_shape = require('../../chunks/annotation-shape-ITsXRPrH.cjs');
const require_annotation_draw = require('../../chunks/annotation-draw-CHVQYiQr.cjs');
