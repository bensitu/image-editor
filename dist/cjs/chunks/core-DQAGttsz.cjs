...
const require_plugin_manager = require('./plugin-manager-BdEFq773.cjs');
...
function freezePluginDefinition(definition) {
	if (!("manifest" in definition)) return require_plugin_manager.aliasPluginDefinitionIdentity(Object.freeze({
		...definition,
	...
	return require_plugin_manager.aliasPluginDefinitionIdentity(Object.freeze({
		...definition,
...
//# sourceMappingURL=core-DQAGttsz.cjs.map