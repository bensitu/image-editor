...
function cloneMetadataValue(value, depth, budget) {
	...
	try {
		...
		for (const [key, entry] of entries) {
			if (require_plugin_identifier.isDangerousStateKey(key) || key.length === 0 || key.length > 128) throw new AnnotationValidationError("Annotation metadata contains an unsafe key.");
...
//# sourceMappingURL=annotation-DOGHiusu.cjs.map