...
const require_annotation = require('./annotation-DOGHiusu.cjs');
const require_safe_fabric_serialization = require('./safe-fabric-serialization-D8oNU9St.cjs');
...
//# sourceMappingURL=annotation-draw-Cn36E2MY.cjs.map