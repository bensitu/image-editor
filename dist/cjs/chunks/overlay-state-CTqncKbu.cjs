...
const require_core = require('./core-CJFF96DE.cjs');
...
const require_overlay = require('./overlay-CJHKQQlx.cjs');
...
function createOverlayStateContext(baseImagePort) {
	...
	if (!require_core.isFiniteAffineMatrix(matrixValue)) throw new TypeError("[ImageEditor] Base Image transform is invalid.");
	const matrix = matrixValue;
	const inverse = require_core.invertAffine(matrix);
	...
	const canvasScale = Math.sqrt(Math.abs(require_core.affineDeterminant(matrix)));
	...
	const codec = Object.freeze({
		...
		toImageNormalized(point) {
			const local = require_core.applyAffineToPoint(inverse, point);
		...
		toCanvasPoint(point) {
			return require_core.applyAffineToPoint(matrix, {
...
function cloneJsonValue(value, path, depth, context) {
	...
	try {
		...
		for (const key of keys) {
			...
			if (require_safe_object_key.isUnsafeObjectKey(key)) {
...
function validIdentifier(value, path, limits, issues, persistent = false) {
	if (typeof value !== "string" || value.length === 0 || value.length > limits.maxIdentifierLength || !(persistent ? PERSISTENT_ID_PATTERN.test(value) : require_plugin_identifier.isRuntimeIdentifier(value))) {
...
const overlayStatePluginRef = require_core_capabilities.definePluginRef("plugin:overlay-state", "1.0.0");
...
//#endregion
Object.defineProperty(exports, 'DEFAULT_OVERLAY_STATE_LIMITS', {
  enumerable: true,
  get: function () {
    return DEFAULT_OVERLAY_STATE_LIMITS;
  }
});
Object.defineProperty(exports, 'OVERLAY_STATE_COORDINATE_SPACE', {
  enumerable: true,
  get: function () {
    return OVERLAY_STATE_COORDINATE_SPACE;
  }
});
Object.defineProperty(exports, 'OVERLAY_STATE_SCHEMA', {
  enumerable: true,
  get: function () {
    return OVERLAY_STATE_SCHEMA;
  }
});
Object.defineProperty(exports, 'OVERLAY_STATE_WIRE_VERSION', {
  enumerable: true,
  get: function () {
    return OVERLAY_STATE_WIRE_VERSION;
  }
});
Object.defineProperty(exports, 'OverlayStateCodecError', {
  enumerable: true,
  get: function () {
    return OverlayStateCodecError;
  }
});
Object.defineProperty(exports, 'OverlayStateIdConflictError', {
  enumerable: true,
  get: function () {
    return OverlayStateIdConflictError;
  }
});
Object.defineProperty(exports, 'OverlayStateImageMissingError', {
  enumerable: true,
  get: function () {
    return OverlayStateImageMissingError;
  }
});
Object.defineProperty(exports, 'OverlayStatePluginDisposedError', {
  enumerable: true,
  get: function () {
    return OverlayStatePluginDisposedError;
  }
});
Object.defineProperty(exports, 'OverlayStateValidationError', {
  enumerable: true,
  get: function () {
    return OverlayStateValidationError;
  }
});
Object.defineProperty(exports, 'overlayStatePlugin', {
  enumerable: true,
  get: function () {
    return overlayStatePlugin;
  }
});
Object.defineProperty(exports, 'overlayStatePluginRef', {
  enumerable: true,
  get: function () {
    return overlayStatePluginRef;
  }
});
//# sourceMappingURL=overlay-state-CTqncKbu.cjs.map