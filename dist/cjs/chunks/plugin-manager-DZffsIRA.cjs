...
var PluginManager = class {
	...
	performInstallSync(input) {
		...
		const pluginId = plugin.ref.id;
		if (this.installed.get(pluginId)) throw new require_plugin_identifier.PluginAlreadyInstalledError(pluginId);
...
//# sourceMappingURL=plugin-manager-DZffsIRA.cjs.map