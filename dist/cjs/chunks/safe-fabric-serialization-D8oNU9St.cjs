...
function isSafeSerializedFabricObject(value, options) {
	...
	const inspect = (entry, depth, root, propertyName) => {
		...
		for (const key of Object.keys(entry)) {
			if (require_plugin_identifier.isDangerousStateKey(key)) return false;
...
//#endregion
Object.defineProperty(exports, 'isSafeSerializedFabricObject', {
  enumerable: true,
  get: function () {
    return isSafeSerializedFabricObject;
  }
});
//# sourceMappingURL=safe-fabric-serialization-D8oNU9St.cjs.map