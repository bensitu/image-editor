...
class InvalidPluginDefinitionError extends PluginError {
...
class InvalidCapabilityVersionError extends PluginError {
...
var validExports$1 = requireValid$1();
var valid$1 = /*@__PURE__*/getDefaultExportFromCjs(validExports$1);
...
var validRange = /*@__PURE__*/getDefaultExportFromCjs(validExports);

function isValidSemVer(version) {
    return version.trim() === version && valid$1(version, { loose: false }) !== null;
}
...
const CORE_HOST_CAPABILITY = createCapabilityToken('core.host', '1.0.0');
const CORE_STATE_CAPABILITY = createCapabilityToken('core.state', '1.0.0');
const GEOMETRY_CAPABILITY = createCapabilityToken('core.geometry', '1.0.0');
const CORE_EXPORT_CAPABILITY = createCapabilityToken('core.export', '1.0.0');

exports.CORE_EXPORT_CAPABILITY = CORE_EXPORT_CAPABILITY;
exports.CORE_HOST_CAPABILITY = CORE_HOST_CAPABILITY;
exports.CORE_STATE_CAPABILITY = CORE_STATE_CAPABILITY;
exports.CapabilityConflictError = CapabilityConflictError;
exports.GEOMETRY_CAPABILITY = GEOMETRY_CAPABILITY;
...
//# sourceMappingURL=internal-capabilities-DIerpWRs.cjs.map
