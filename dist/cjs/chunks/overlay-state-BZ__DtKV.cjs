...
const require_core = require('./core-DQAGttsz.cjs');
const require_sdk = require('./sdk-DULljMMa.cjs');
const require_overlay = require('./overlay-CehZ3aUk.cjs');
...
function cloneJsonValue(value, path, depth, context) {
	...
	try {
		...
		for (const key of keys) {
			...
			if (require_plugin_identifier.isDangerousStateKey(key)) {
...
//# sourceMappingURL=overlay-state-BZ__DtKV.cjs.map