...
export interface ImportOverlayStateResult {
    ...
    regeneratedIds: Array<{ originalId: string; newId: string }>;
...
export type SerializedMaskGeometry =
    | SerializedRectMaskGeometry
    | SerializedCircleMaskGeometry
...
export type SerializedShapeGeometry =
    SerializedShapeRectGeometry | SerializedShapeLineGeometry | SerializedShapeArrowGeometry;
