...
export type {
    ...
    OverlayExportContext,
    OverlayImageInfo,
    OverlayImportContext,
    OverlayImportWarning,
    OverlayMetadata,
    OverlayMigrationResult,
    OverlaySerializerRegistryEntry,
    OverlayState,
    ...
    SerializedEllipseMaskGeometry,
    SerializedMaskGeometry,
    SerializedMaskOverlay,
    SerializedMaskStyle,
    SerializedOverlay,
    SerializedOverlayBase,
    SerializedPolygonMaskGeometry,
    SerializedRectMaskGeometry,
    SerializedShapeAnnotationOverlay,
    SerializedShapeArrowGeometry,
    SerializedShapeGeometry,
    SerializedShapeLineGeometry,
    SerializedShapeRectGeometry,
    SerializedShapeStyle,
    SerializedTextAnnotationOverlay,
    SerializedTextContent,
    SerializedTextGeometry,
    SerializedTextStyle,
