/**
 * Maps official Plugin identities to their independently importable package entries.
 *
 * @module
 */

export interface OfficialPluginPackageHint {
    readonly pluginId: string;
    readonly packageName: string;
}

export const OFFICIAL_PLUGIN_PACKAGE_HINTS: readonly OfficialPluginPackageHint[] = Object.freeze([
    Object.freeze({
...
const packageHintsByPluginId = new Map(
    OFFICIAL_PLUGIN_PACKAGE_HINTS.map(({ pluginId, packageName }) => [pluginId, packageName]),
);

export function getOfficialPluginPackageHint(pluginId: string): string | undefined {
