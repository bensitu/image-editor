...
export type {
    ...
    DocumentMutationErrorSink,
    DocumentMutationEventPort,
    DocumentMutationFaultSink,
    DocumentMutationHistoryPort,
    DocumentMutationHistoryRecord,
    DocumentMutationKind,
    DocumentMutationMementoPort,
    ...
    DocumentMutationStatePort,
    DocumentMutationWarning,
    DocumentMutationWarningSink,
    MutationCommitOwner,
