...
import type {
    EditorToolMode,
    ImageEditor as ImageEditorInstance,
...
export default function ImageEditorClient() {
    ...
    function refreshPublicState(editor: ImageEditorInstance) {
    ...
    useEffect(() => {
        ...
        async function setupEditor() {
            ...
            const [{ ImageEditor }, fabric] = await Promise.all([
                import('@bensitu/image-editor'),
                import('fabric'),
            ]);
    ...
    async function runEditorAction(
        action: (editor: ImageEditorInstance) => unknown | Promise<unknown>,
    ) {
