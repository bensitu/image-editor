...
| `maxInputPixels`                  | `50000000`            | Maximum source image pixel count accepted from PNG/JPEG/WebP headers before image decode. JPEG metadata segments are traversed until the dimensions marker is found. Invalid values fall back to this default.                                                                                |
